...
class Upcomming_Appoinments extends StatefulWidget {
  Upcomming_Appoinments({this.username});

  final username;

  @override
  _Upcomming_AppoinmentsState createState() => _Upcomming_AppoinmentsState();
}

class _Upcomming_AppoinmentsState extends State<Upcomming_Appoinments> {
  ...
  _gethistory() async {
    ...
    history = await datab.getUpcomming(widget.username);
    _builComp();
    print("Done");
  }
